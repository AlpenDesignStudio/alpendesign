...
<head>
 ...
 <body class="theme-red">
                    ...
                    <div class="row clearfix" style="text-align: center;">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card" >
                                ...
                                WUDTOOLS - FILE UPLOAD - DRAG & DROP OR WITH CLICK & CHOOSE
                            </h2>
                                </div>
                                <div class="body">
    ...
    while($row=mysql_fetch_array($result_set))
    {
        ...
        <a href="wudtoolsupload/<?php echo $row['file'] ?>"  class="btn bg-orange btn-lg btn-block waves-effect" type="button" target="_blank"><?php echo $row['file'] ?></a></div>
...
{    
    ...
    {
        $sql="INSERT INTO tbl_wudtools(file,type,size) VALUES('$final_file','$file_type','$new_size')";
        mysql_query($sql);
        ?>
        <script>
        /*alert('successfully uploaded');*/
        window.location.href='wudtools.php?success';
    ...
    else
    {
        ...
        window.location.href='wudtools.php?fail';
        </script>
        <?php
    }
}
