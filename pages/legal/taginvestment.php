...
<head>
 ...
 <body class="theme-red">
                    ...
                    <div class="row clearfix" style="text-align: center;">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card" >
                                ...
                                <div class="body">
                                    <form action="upload1.php" id="" class="" method="post" enctype="multipart/form-data">
    ...
    while($row=mysql_fetch_array($result_set))
    {
        ...
        <a href="taginvestmentupload/<?php echo $row['file'] ?>"  class="btn bg-orange btn-lg btn-block waves-effect" type="button" target="_blank"><?php echo $row['file'] ?><span class="badge"><?php echo $row['id'] ?></span></a></div>
