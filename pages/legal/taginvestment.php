...
?>
    ...
    <head>
        ...
        <title>Tag Investment Project Analysis</title>
        <!-- Favicon-->
    ...
    ?>
                                                                ...
                                                                <?php
    $sql="SELECT * FROM tbl_investment";
    // echo $sql;die();
    ...
    while($row=mysql_fetch_array($result_set))
    {
        ...
        ?>
                                                                    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
                                                                        <a href="taginvestmentupload/<?php echo $row['file'] ?>" class="btn bg-orange btn-lg btn-block waves-effect" type="button" target="_blank">
                                                                            <?php echo $row['file'] ?></a>
                                                                    </div>
...
{    
    ...
    {
        $sql="INSERT INTO tbl_investment(file,type,size) VALUES('$final_file','$file_type','$new_size')";
        mysql_query($sql);
        ?>
                                                                            <script>
                                                                                /*alert('successfully uploaded');*/
                                                                                window.location.href = 'taginvestment.php?success';
                                                                            </script>
                                                                            <?php
    }
    else
    {
        ?>
                                                                                <script>
                                                                                    ...
                                                                                    window.location.href = 'taginvestment.php?fail';
                                                                                </script>
                                                                                <?php
    }
}
