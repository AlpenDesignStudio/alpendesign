                    ...
                    <div class="row clearfix" style="text-align: center;">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card" >
                                ...
                                TWEX - FILE UPLOAD - DRAG & DROP OR WITH CLICK & CHOOSE
                            </h2>
                                </div>
                                <div class="body">
...
{    
    ...
    {
        $sql="INSERT INTO tbl_twex(file,type,size) VALUES('$final_file','$file_type','$new_size')";
        mysql_query($sql);
        ?>
        <script>
        /*alert('successfully uploaded');*/
        window.location.href='twex.php?success';
    ...
    else
    {
        ...
        window.location.href='twex.php?fail';
        </script>
        <?php
    }
}
