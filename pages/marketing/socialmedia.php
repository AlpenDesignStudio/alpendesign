...
<head>
 ...
 <body class="theme-red">
    ...
    <?php
    $sql="SELECT * FROM socialmedia_uploads ORDER BY id ASC";
    // echo $sql;die();
    ...
    {   
        ...
        <a href="socialmedia/<?php echo $row['file'] ?>"  class="btn bg-cyan btn-lg btn-block waves-effect" type="button" target="_blank"><?php echo $row['file'] ?></a></div>
...
{    
    ...
    {
        $sql="INSERT INTO socialmedia_uploads(file,type,size) VALUES('$final_file','$file_type','$new_size')";
        mysql_query($sql);
        ?>
        <script>
        /*alert('successfully uploaded');*/
        window.location.href='socialmedia.php?success';
    ...
    else
    {
        ...
        window.location.href='socialmedia.php?fail';
        </script>
        <?php
    }
}
