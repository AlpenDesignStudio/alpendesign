...
<head>
 ...
 <body class="theme-red">
    ...
    <?php
    $sql="SELECT * FROM ndauploads ORDER BY id ASC";
    // echo $sql;die();
    ...
    {   
        ...
        <a href="ndauploads/<?php echo $row['file'] ?>"  class="btn bg-cyan btn-lg btn-block waves-effect" type="button" target="_blank"><?php echo $row['file'] ?></a></div>
...
{    
    ...
    {
        $sql="INSERT INTO ndauploads(file,type,size) VALUES('$final_file','$file_type','$new_size')";
        mysql_query($sql);
        ?>
        <script>
        /*alert('successfully uploaded');*/
        window.location.href='nda.php?success';
