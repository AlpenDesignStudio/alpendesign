...
<head>
 ...
 <body class="theme-red">
        ...
        <div class="row clearfix" style="text-align: center;">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card" >
                                ...
                                DOWNLOAD OR UPLOAD MAILER FOR MARKETING
                            </h2>
                                </div>
                                <div class="body">
    ...
    <?php
    $sql="SELECT * FROM mailerupload ORDER BY id ASC";
    // echo $sql;die();
    ...
    {   
        ...
        <a href="mailerupload/<?php echo $row['file'] ?>"  class="btn bg-cyan btn-lg btn-block waves-effect" type="button" target="_blank"><?php echo $row['file'] ?></a></div>
...
{    
    ...
    {
        $sql="INSERT INTO mailerupload(file,type,size) VALUES('$final_file','$file_type','$new_size')";
        mysql_query($sql);
        ?>
        <script>
        /*alert('successfully uploaded');*/
        window.location.href='mailer.php?success';
    ...
    else
    {
        ...
        window.location.href='mailer.php?fail';
        </script>
        <?php
    }
}
