...
<head>
 ...
 <body class="theme-red">
    ...
    <?php
    $sql="SELECT * FROM crowduploads ORDER BY id ASC";
    // echo $sql;die();
    ...
    {   
        ...
        <a href="crowduploads/<?php echo $row['file'] ?>"  class="btn bg-cyan btn-lg btn-block waves-effect" type="button" target="_blank"><?php echo $row['file'] ?></a></div>
...
{    
    ...
    {
        $sql="INSERT INTO crowduploads(file,type,size) VALUES('$final_file','$file_type','$new_size')";
        mysql_query($sql);
        ?>
        <script>
        /*alert('successfully uploaded');*/
        window.location.href='crowd.php?success';
    ...
    else
    {
        ...
        window.location.href='crowd.php?fail';
        </script>
        <?php
    }
}
