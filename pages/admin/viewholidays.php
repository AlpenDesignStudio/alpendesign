...
<button type='button' class='btn1 bg-red waves-effect' style='width: 100%;background-color:red;' >
...
<button type='button' class='btn1 bg-red waves-effect' style='width: 100%;'>
      <i class='material-icons'>report_problem</i><a href='delete.php?id=" . $row->id . "'>
      <b style='color: white !important;';>Delete Record</b></a></button>
</td>";
// echo "<td><a href='delete.php?id=" . $row->id . "'>Delete</a></td>";
